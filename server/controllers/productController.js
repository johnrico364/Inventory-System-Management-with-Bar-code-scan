...
const getArchivedProducts = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Error fetching archived products", error: error.message });
    }
}
...
const updateProductByBarcode = async (req, res) => {
    ...
    try {
        ...
        const product = await Product.findOne({ barcode: barcodeNumber, isDeleted: false });
...
const logTransaction = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ message: "Error logging transaction", error: error.message });
    }
}
...
const getProductHistory = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ message: "Error fetching product history", error: error.message });
    }
}
